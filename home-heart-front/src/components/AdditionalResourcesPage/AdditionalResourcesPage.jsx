  ...
  return (
    <Box className={classes.banner}>
      <Box>
        ...
        >
          It's okay to not feel okay. We all feel sad, anxious, upset, or angry
          sometimes, If you, your family or friends are feeling overwhelmed or
          need someone to talk to, contact one of the resources below.
        </Typography>
      </Box>
    </Box>
  );
