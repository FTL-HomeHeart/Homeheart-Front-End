...
const BannerComponent = () => {
  ...
  return (
    ...
    >
      <Box sx={{width: "60%", color:"#fff", margin: "0 auto", fontFamily: "Inter, sans-serif",}}>
        ...
        <Typography variant="body1" gutterBottom sx={{fontSize: "18px"}}>
          With our matching process, we hope that you are able to find the right professionals 
          to help you with your mental health. Feel free to save any professionals that you are 
          interested in and book an appointment with them. Wanna see more details about a 
          specific professinal? Click on the "Learn More" button! 
        </Typography>
      </Box>
    </Box>
  );
